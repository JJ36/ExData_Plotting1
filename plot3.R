plot3 <- function() {
        #plot3() download the data from internet, and plot the evolution of 
        #the Energy sub metering during 01/02/2007 and 02/02/2007
        ...
        # creating the plot in the PNG graphic device plot3.png  
