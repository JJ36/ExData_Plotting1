plot1 <- function() {      
        #plot1() download the data from internet, and plot an histogram of 
        #the global active power of 01/02/2007 and 02/02/2007
...
#         }
        ...
        # creating the plot in the PNG graphic device plot1.png
